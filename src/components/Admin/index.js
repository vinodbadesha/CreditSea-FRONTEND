    ...
    return (
        <div className="verifier-container">
            ...
            <div className="verifier-main-container">
                <p className="admin-dashboard">Dashboard</p>
                <div className="all-stats-container">
                    <div className="admin-each-stat-container">
                        <div className="admin-stat-img-container">
                            <img src="https://res.cloudinary.com/diaakrqlt/image/upload/v1746789222/Vector-11_dfliv5.png" alt="loans" />
                        </div>
                        <div className="admin-stat-info-container">
                            <p>200</p>
                            <p>ACTIVE USERS</p>
                        </div>
                    </div>
                    ...
                    <div className="admin-applied-loans-container">
